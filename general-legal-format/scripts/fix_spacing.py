#!/usr/bin/env python3
"""
Fix spacing in a legal document to match the ABP Capital template.
...
def find_pack_script():
    ...
    # Go up from general-legal-format/scripts/ to the workspace root
...
def main():
    parser = argparse.ArgumentParser(
        description="Fix spacing in a legal document to match the ABP Capital template."
    )
